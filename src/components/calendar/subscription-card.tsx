  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <div
          className="text-primary-foreground flex h-10 w-10 items-center justify-center rounded-lg text-sm font-semibold"
          style={{ backgroundColor: subscription.color || 'var(--color-primary)' }}
        >
        ...
        {!isRecorded && (
          <div className="flex items-center gap-2">
            ...
            <Button
              size="sm"
              onClick={onMarkPaid}
              className="border-success/30 bg-success/20 text-success hover:bg-success/30 border"
            >
